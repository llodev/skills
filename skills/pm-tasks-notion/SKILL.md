...
Placeholder. Will follow the same architecture as `pm-tasks-trello` and `pm-tasks-asana` once `notion`'s MCP is integrated. See [`../pm-tasks-core/SKILL.md`](../pm-tasks-core/SKILL.md) and [`../pm-tasks-trello/SKILL.md`](../pm-tasks-trello/SKILL.md) for the pattern.
