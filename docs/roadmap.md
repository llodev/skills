...
| v1.5.0                        | Adapters TS migration + @llodev/pm-tasks-testkit + 7th canonical verb task.move + E2E canary                    | ✅ delivered v1.5.0                 | Branch v1.5.0 (this PR); @llodev/pm-tasks-{asana,trello}@1.5.0 + @llodev/pm-tasks-testkit@0.1.0                                                                         |
