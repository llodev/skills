...
Date: 2026-06-17. Baseline: `main` at commit `2980380` (v1.4.0 merged via PR #7). Forward-looking roadmap — single source of truth for the project; each item carries **real status** (delivered / partial / pending) and **priority**.
...
| v1.3.2 (PR #6)                | Repo organization — scripts/ subfolders + SKILL.md translations dropped + localized READMEs → docs/i18n/        | ✅ delivered v1.3.2                 | Branch v1.3.2 merged via PR #6                                                                                                                                          |
| v1.4.0 (PR #7)                | pm-tasks-core TypeScript migration — src/init-lib.ts, src/i18n/registry.ts, Vitest 2.x, dist exports with .d.ts | ✅ delivered v1.4.0                 | Branch v1.4.0 merged via PR #7; @llodev/pm-tasks-core@1.4.0 on npm                                                                                                      |
| v1.5.0 (this PR)              | Adapters TS migration + @llodev/pm-tasks-testkit + 7th canonical verb task.move + E2E canary                    | ✅ delivered v1.5.0                 | Branch v1.5.0; @llodev/pm-tasks-core@1.5.0 (task.move) + @llodev/pm-tasks-{asana,trello}@1.4.0 (TS) + @llodev/pm-tasks-testkit@0.1.0                                    |
